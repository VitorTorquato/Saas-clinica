...
import logoImg from "../../../../../public/images/logo-odonto.png";
...
export function SideBarDashboard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full">
      <aside
        className={clsx(
          "flex flex-col border-r bg-background transition-all p-4 duration-300 h-full",
          {
            "w-20": isCollapsed,
            "w-64": !isCollapsed,
      ...
      >
        ...
        {/* mostrar quando a sidebar esta recolhida */}
