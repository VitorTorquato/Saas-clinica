...
import { Banknote, CalendarCheck2, Folder, List, ReceiptRussianRubleIcon, Settings } from "lucide-react";
...
function SidebarLink({href,icon,isCollapsed,label,pathname} : SideBarLinkProps){
    return(
        <Link href={href}>
            <div className={clsx("flex item-center gap-2 px-3 py-2 rounded-md transition-colors" , {
